                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseOne" class="accordion-collapse collapse show" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <a class="nav-link" href="../remove/deleteStudent.php"><b>Xóa thông tin học sinh</b></a>
                ...
                <div class="accordion-item">
                  ...
                  <div id="collapseTwo" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <button class="nav-link" id="list-teacher"><b>Danh sách giáo viên</b></button>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                  ...
                  <div id="collapseThree" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        ...
                        <button class="nav-link" id="list-course"><b>Danh sách khóa học</b></button>
                    </div>
                  </div>
                </div>
                <div class="accordion-item">
                    ...
                    <div id="collapseFour" class="accordion-collapse collapse" data-bs-parent="#accordionExample">
                      <div class="accordion-body">
                          <button class="nav-link" id="list-class"><b>Danh sách lớp</b></button>
                      </div>
                    </div>
                  </div>
              </div>
